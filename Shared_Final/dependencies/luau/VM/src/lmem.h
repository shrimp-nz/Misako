...
LUAI_FUNC void* luaM_new_(misako_State* L, size_t nsize, uint8_t memcat);
LUAI_FUNC GCObject* luaM_newgco_(misako_State* L, size_t nsize, uint8_t memcat);
LUAI_FUNC void luaM_free_(misako_State* L, void* block, size_t osize, uint8_t memcat);
LUAI_FUNC void luaM_freegco_(misako_State* L, GCObject* block, size_t osize, uint8_t memcat, lua_Page* page);
LUAI_FUNC void* luaM_realloc_(misako_State* L, void* block, size_t osize, size_t nsize, uint8_t memcat);

LUAI_FUNC l_noret luaM_toobig(misako_State* L);
...
LUAI_FUNC void luaM_visitgco(misako_State* L, void* context, bool (*visitor)(void* context, lua_Page* page, GCObject* gco));
