...
const TValue* luaT_gettmbyobj(misako_State* L, const TValue* o, TMS event)
{
    /*
...
const TString* luaT_objtypenamestr(misako_State* L, const TValue* o)
{
...
const char* luaT_objtypename(misako_State* L, const TValue* o)
{
