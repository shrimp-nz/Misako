...
static void validatestack(global_State* g, misako_State* l)
{
...
void luaC_validate(misako_State* L)
{
    global_State* g = L->global;
...
static void dumpthread(FILE* f, misako_State* th)
{
    size_t size = sizeof(misako_State) + sizeof(TValue) * th->stacksize + sizeof(CallInfo) * th->size_ci;
...
void luaC_dump(misako_State* L, void* file, const char* (*categoryName)(misako_State* L, uint8_t memcat))
{
    global_State* g = L->global;
