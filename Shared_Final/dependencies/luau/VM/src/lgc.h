...
LUAU_FASTFLAG(MisakoRVMNoSleepBit)

/*
** Default settings for GC tunables (settable via lua_gc)
*/
#define LUAI_GCGOAL 150    // 200% (allow heap to double compared to live heap size)
#define LUAI_GCSTEPMUL 250 // GC runs 'twice the speed' of memory allocation
#define LUAI_GCSTEPSIZE 4096  // GC runs every KB of memory allocation
...
// Thread stack states
// TODO: Remove with FFlag::MisakoRVMNoSleepBit and replace with misako_State::threadactive
...
// TODO: Remove with FFlag::MisakoRVMSimplerUpval
...
LUAI_FUNC void luaC_freeall(misako_State* L);
LUAI_FUNC size_t luaC_step(misako_State* L, bool assist);
LUAI_FUNC void luaC_fullgc(misako_State* L);
LUAI_FUNC void luaC_initobj(misako_State* L, GCObject* o, uint8_t tt);
LUAI_FUNC void luaC_upvalclosed(misako_State* L, UpVal* uv);
LUAI_FUNC void luaC_barrierupval(misako_State* L, GCObject* v);
LUAI_FUNC void luaC_barrierf(misako_State* L, GCObject* o, GCObject* v);
LUAI_FUNC void luaC_barriertable(misako_State* L, Table* t, GCObject* v);
LUAI_FUNC void luaC_barrierback(misako_State* L, GCObject* o, GCObject** gclist);
LUAI_FUNC void luaC_validate(misako_State* L);
LUAI_FUNC void luaC_dump(misako_State* L, void* file, const char* (*categoryName)(misako_State* L, uint8_t memcat));
LUAI_FUNC int64_t luaC_allocationrate(misako_State* L);
LUAI_FUNC void luaC_wakethread(misako_State* L);
