...
LUAI_FUNC void luaS_resize(misako_State* L, int newsize);

LUAI_FUNC TString* luaS_newlstr(misako_State* L, const char* str, size_t l);
LUAI_FUNC void luaS_free(misako_State* L, TString* ts, struct lua_Page* page);

LUAI_FUNC TString* luaS_bufstart(misako_State* L, size_t size);
LUAI_FUNC TString* luaS_buffinish(misako_State* L, TString* ts);
