...
// Don't have MisakoRVM::Variant available, it's a bit of an overhead, but a plain struct is nice to use
...
template<>
struct hash<MisakoRVM::AstName>
{
    size_t operator()(const MisakoRVM::AstName& value) const
    {
