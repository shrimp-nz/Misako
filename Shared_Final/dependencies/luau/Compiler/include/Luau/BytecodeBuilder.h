...
public:
    ...
    void emitABC(MisakoRVMOpcode op, uint8_t a, uint8_t b, uint8_t c);
    void emitAD(MisakoRVMOpcode op, uint8_t a, int16_t d);
    void emitE(MisakoRVMOpcode op, int32_t e);
